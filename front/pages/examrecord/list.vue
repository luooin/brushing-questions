		...
		<view @tap="onDetailTap(item)" class="cu-list menu-avatar" v-for="(item,index) in list" v-bind:key="index">
			<view class="cu-item">
				<view class="content" style="left: 20rpx;">
					<view class="text-grey">试题库名称：{{item.papername}}&nbsp;&nbsp;({{item.username}})</view>
				</view>
				<view class="action" style="width: auto;display:flex;flex-direction:column;" v-if="item.ismark>0">
					...
					<view class="cu-tag round bg-green sm" style="margin:4px 0 0">准确率：暂无</view>
					<view class="cu-tag round bg-red sm" style="margin:4px 0 0">错误率：暂无</view>
				</view>
