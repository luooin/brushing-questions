		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#F2F2F2","height":"auto"}'>
            <view :style='{"padding":"0 10rpx","margin":"-40rpx auto 0","borderRadius":"30rpx 30rpx 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 20rpx)","position":"relative","height":"auto","zIndex":"11"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"0 20rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"5"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#6c6c6c","textAlign":"right"}'>考试分类：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)","flex":"1"}'>{{detail.kaoshifenlei}}</view>
				</view>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('kaoshifenlei', this.id);
		...
		methods: {
			...
			async init(type=1){
				...
				let res = await this.$api.info('kaoshifenlei', this.id);
				this.detail = res.data;

				if(type==2){
					this.detail.discussnum++
					await this.$api.update('kaoshifenlei',this.detail)
				}
			},
