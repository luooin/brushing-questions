		...
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#F2F2F2","height":"auto"}'>
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx 0","background":"none","display":"flex","height":"auto"}'>
				...
				<view :style='{"margin":"0 0 0 12rpx","flex":"1","position":"relative"}' v-if="queryIndex==0" class="search-form round">
					...
					<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"10rpx","background":"#F8F8F8","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.zhanghao" type="text" placeholder="账号" ></input>
				</view>
				<view :style='{"margin":"0 0 0 12rpx","flex":"1","position":"relative"}' v-if="queryIndex==1" class="search-form round">
					<text class="icon iconfont icon-fangdajing07" :style='{"color":"rgb(153, 153, 153)","left":"0px","textAlign":"center","width":"80rpx","fontSize":"40rpx","lineHeight":"80rpx","position":"absolute","right":"0px"}'></text>
					<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"10rpx","background":"#F8F8F8","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.xingming" type="text" placeholder="姓名" ></input>
				</view>
			...
			<view class="uni-product-list" :style='{"padding":"10rpx 20rpx","margin":"0 auto","borderRadius":"10rpx","flexWrap":"wrap","background":"#fff","flex":"1","display":"flex","width":"calc(100% - 160rpx)","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"boxShadow":"none","padding":"0 0 10rpx","margin":"0 0 20rpx","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240104/f251fe8ff5ac4c80afbbaad725ab3bbb.png)","display":"flex","width":"48%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"width":"100%","padding":"4rpx 20rpx","lineHeight":"60rpx","fontSize":"28rpx","color":"#000","order":"1"}'>{{product.zhanghao}}</view>
					<image :style='{"padding":"0","margin":"0 auto ","objectFit":"cover","display":"block","width":"80%","height":"160rpx","order":"2"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.touxiang)" :src="product.touxiang.split(',')[0]"></image>
					<image :style='{"padding":"0","margin":"0 auto ","objectFit":"cover","display":"block","width":"80%","height":"160rpx","order":"2"}' mode="aspectFill" class="uni-product-image" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
